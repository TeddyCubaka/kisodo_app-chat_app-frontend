  ...
  return (
    <div className="mum_card">
      ...
      <fieldset className="fieldset_of_connexion">
        ...
        />
        <label>
          Enter your mail address {mailSize > 1 ? mailSize : false} {CorrectMail}{" "}
        </label>
        <input
          type="mail"
          name="email"
        ...
        />
        <label>
          What&lsquos your password {pwdSize > 1 ? pwdSize : false} {nicePwdSize}
        </label>
        <input
          type="password"
          name="password"
        ...
        <input
          ...
          value="Sign up"
          onClick={() => {
            mailSize < 10 ? setCorrectMail("Check your mail") : setCorrectMail("");
            pwdSize < 8
